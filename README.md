# Home_Garden_Advisor
このプロジェクトは、[家庭菜園という限定的な気温を測定し、予測推移と合わせてAIが作物にすべき作業を提示してくれる農業初心者のためのもの]です。
...
1.  **ESP32からのデータ受信**:
    - ESP32からHTTP GETリクエストで気温・湿度データを受け取ります。
...
![実機](images/main_device.jpg)
![LINEに来る実際の結果](images/advice_image.jpg)

---

## ? 貢献方法

バグの報告や改善提案を歓迎します。IssueまたはPull Requestにてご連絡ください。